...
public class Java12DocTreeHtmlParser implements JavaDocTreeHtmlParser {
    ...
    private _Class parseSingleClassDocument(final File classHtml) throws IOException {
        ...
        final String _package = StringUtils.substringBefore(doc.select("h2 + pre b").text(), "." + className);
